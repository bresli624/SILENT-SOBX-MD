...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "SILENT-SOBX-MD~jJwgQQTI#TFaJXGS1VQrEQVie6QVu0qJ8-sWMeSNCv8HPPGyeFIk",
    ...
    BOT_NAME: process.env.BOT_NAME || "✭🍷⍣⃝𝐔𝚪_𝐂𝚪𝐔𝐒𝚮 𝐊𝚫𝐋𝚫𝐒𝚮𝐘🌹✮⃝👑✭",
